...
func main() {
	...
	covertDTLSConfig := flag.String("covertdtls-config", "randomizemimic", "Configuration of DTLS mimicking and randomization: mimic, randomize, randomizemimic. Using randomizemimic is recommended for best stability and provides good fingerprint-resistance against block-listing. Using randomize is less stable, but provides better fingerprint-resistance against allow-listing. Leave empty to disable.")
